  ...
  return (
    <main className="App">
      ...
      <section id="contact">
                <h2>Contact</h2>
                <div>
                    <a href="https://docs.google.com/document/d/1IG3LCk6lxiGOLJM3HiRph8jTf7U4lWoczZCQMlfMTaE/edit?usp=sharing" ><img class = 'logo' src="portfolio/src/Components/Images/download icon.webp" alt='download icon'/></a>
